...
function CTAButton({
  ...
  const variantStyles = {
    primary:
      'bg-bhm-gold-300 text-bhm-neutral-950 px-20 shadow-xl font-semibold border-bhm-gold-950 hover:border-bhm-gold-500 hover:bg-bhm-gold-400 hover:shadow-xl',
    secondary:
