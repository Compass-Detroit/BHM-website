    ...
    <PageLayout>
      ...
      >
        <div className="flex flex-col items-center justify-center px-8 py-12 sm:px-10 sm:py-16 md:px-14 md:py-20 lg:px-16 lg:py-24">
          ...
          <p className="mx-auto w-5/6 text-2xl leading-relaxed text-primary-950 lg:w-2/3">
          ...
          <p className="mx-auto mt-4 w-5/6 text-lg leading-relaxed text-bhm-neutral-700 lg:w-2/3">
            The{' '}
            <a
          ...
          <p className="mx-auto mt-4 w-5/6 text-lg leading-relaxed text-bhm-neutral-700 lg:w-2/3">
            ...
            and continues a tradition of collaborative learning.
          </p>
